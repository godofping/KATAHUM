...
<?php include('header.php'); ?>
          ...
          <div class="block-web">
           <div class="header">
             <br>
              ...
              <?php if (isset($_GET['viewer']) and isset($_GET['w']) and $_GET['w'] == 'added'): ?>
                <div class="alert alert-success"> <strong><?php echo $_GET['viewer']; ?></strong> is successfully added!</div>
              <?php endif ?>
              <?php if (isset($_GET['viewer']) and isset($_GET['w']) and $_GET['w'] == 'delete'): ?>
                <div class="alert alert-danger"> <strong><?php echo $_GET['viewer']; ?></strong> is successfully deleted!</div>
              <?php endif ?>
              <?php if (isset($_GET['viewer']) and isset($_GET['w']) and $_GET['w'] == 'update'): ?>
                <div class="alert alert-success"> <strong><?php echo $_GET['viewer']; ?></strong> is successfully updated!</div>
              <?php endif ?>
            ...
            <div class="table-responsive">
                <table  class="display table table-bordered table-striped" id="dynamic-table">
                  ...
                  <tbody>
                    ...
                    $qry = mysqli_query($connection, "select * from viewer_table");
                    while ($res = mysqli_fetch_assoc($qry)) { ?>
                      ...
                      <td><a href="javascript:void(0);"  data-toggle="modal" data-target="#EditModal<?php echo $res['viewerid']; ?>">Edit</a> | <a href="javascript:void(0);"  data-toggle="modal" data-target="#DeleteModal<?php echo $res['viewerid']; ?>">Delete</a></td>
                    </tr>
                    <?php } ?>
  ...
  while ($res = mysqli_fetch_assoc($qry)) { ?>
 <!-- Delete Modal -->
<div class="modal fade" id="DeleteModal<?php echo $res['viewerid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div style="text-align: center;"><a href="controller.php?from=delete-viewer-profile&viewerid=<?php echo $res['viewerid'] ?>&viewer=<?php echo $res['firstname'] . " " . $res['middleinitial'] . " " . $res['lastname']; ?>" class="btn btn-primary btn-lg">Yes</a>
...
<!-- Edit Modal -->
<div class="modal fade" id="EditModal<?php echo $res['viewerid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      ...
      <div class="modal-footer">
        ...
        <input type="text" name="from" value="edit-viewer-profile" hidden="" >
