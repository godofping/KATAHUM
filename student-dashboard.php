      ...
      <div class="container clear_both padding_fix">
        ...
        <div class="information green_info">   
            ...
            <div class="information green_info">   
              <div class="information_inner">
                <div class="info green_symbols"><i class="fa fa-users icon"></i></div>
                <span>NUMBER OF MY POSTED SERVICES </span>
                <h1 class="bolded"><?php $qry = mysqli_query($connection, "select count(*) as result from serviceoffered_table where studentid = '" . $_SESSION['studentid'] . "'"); $res = mysqli_fetch_assoc($qry); echo $res['result'];?></h1>
                <div class="infoprogress_green">
                  <div class="greenprogress"></div>
                </div>
